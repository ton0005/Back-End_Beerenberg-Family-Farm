        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StaffId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StaffNumber = table.Column<string>(type: "nchar(7)", fixedLength: true, maxLength: 7, nullable: false),
                    ...
                    WeeklyAvailableHour = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Staff_StaffNumber", x => x.StaffNumber);
                    table.ForeignKey(
                        name: "FK_Staff_ContractTypes_ContractTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PasswordResetTokens_Staff_StaffNumber",
            ...
            migrationBuilder.InsertData(
                table: "ContractTypes",
                columns: new[] { "ContractTypeId", "TypeName" },
                values: new object[,]
                {
                    { 1, "Casual" },
                    { 2, "Part-Time" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_StaffNumber",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AuthUsers_Staff_StaffId",
                table: "AuthUsers",
                column: "StaffId",
                principalTable: "Staff",
                principalColumn: "StaffId",
